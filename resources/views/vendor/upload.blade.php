        ...
        <div class="row">
            <div class="col-md-12">
                <div class="breadcrumb-contents">
                    <h2 class="page-title">Upload Item</h2>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-sm-12">
                    @include("misc.errors")
                    <form action="{{ route('post.new.product') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="title" name="title" class="text_field" placeholder="Enter your product title">
                                        </div>
                                    </div><!-- ends: .col-md-6 -->
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="m-bottom-20 no-margin">
                                            ...
                                            <textarea name="description" class="text_field" rows="4"></textarea>
                                        </div>
                                    </div><!-- ends: .col-md-12 -->
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="brand" id="brand" class="text_field" placeholder="">
                                        </div>
                                    </div><!-- ends: .col-md-6 -->
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="model">Model</label>
                                            <input type="text" name="model" id="model" class="text_field" placeholder="">
                                        </div>
                                    </div><!-- ends: .col-md-6 -->
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="year">Year</label>
                                            <input type="text" name="year" id="year" class="text_field" placeholder="">
                                        </div>
                                    </div><!-- ends: .col-md-6 -->
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="size">Size</label>
                                            <input type="text" name="size" id="size" class="text_field" placeholder="">
                                        </div>
                                    </div><!-- ends: .col-md-6 -->
                                </div><!-- ends: .row -->
                            </div><!-- ends: .upload_modules -->
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="original_price" id="original_price" class="text_field" placeholder="">
                                            </div>
                                        </div>
                                    </div><!-- ends: .col-md-6 -->
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon">$</span>
                                                <input type="text" id="sale_price" name="sale_price" class="text_field" placeholder="">
                                            </div>
                                        </div>
                                    </div><!-- ends: .col-md-6 -->
