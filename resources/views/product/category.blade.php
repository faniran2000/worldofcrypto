...
@section('content')
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="breadcrumb-contents">
                        <h2 class="page-title">{{ ucwords($category->name) }}</h2>
    ...
    <div class="product-list">
        <ul class="nav nav__product-list" role="tablist">
            @foreach($subcategories as $row)
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('product.subcategory', [$category->slug, $row->slug]) }}">{{ $row->name }}</a>
                </li>
            @endforeach
        </ul>
    </div>
